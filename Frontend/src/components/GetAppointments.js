...
const GetAppointments = () => {
    ...
    const fetchAppointments = async () => {
        try {
            ...
            const response = await fetch('http://medimind.in.net:27017/api/v1/consultant/getRequestedAppointmentList', {
                method: 'GET',
                headers: {
    ...
    const handleAccept = async (appointmentId) => {
        try {
            ...
            const response = await fetch('http://medimind.in.net:27017/api/v1/consultant/acceptAppointmentRequest', {
                method: 'POST',
                headers: {
    ...
    const handleReject = async (appointmentId) => {
        try {
            ...
            const response = await fetch('http://medimind.in.net:27017/api/v1/consultant/rejectAppointmentRequest', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
